...
public class StagingFile extends StagingPath {
    private ByteBuffer contents = ByteBuffer.allocate(0);

    public StagingFile(FuseContext context, String name) {
        super(context, name);
    }

    public StagingFile(FuseContext context, String name, StagingDirectory parent) {
        super(context, name, parent);
    }

    public StagingFile(FuseContext context, String name, String text) {
        super(context, name);
        try {
