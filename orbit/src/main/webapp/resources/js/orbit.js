...
function makeLogo() {
  var orbitLogo = document.createElement("DIV");
  addClass(orbitLogo, "orbitLogo");
  addClass(orbitLogo, "toggle");
  var orbitTxt = document.createElement("DIV");
  addClass(orbitTxt, "orbitTxt");
  orbitTxt.textContent = "Orbit";
  orbitLogo.appendChild(orbitTxt);
  return orbitLogo;
}
